...
def verify_master_password():
    master_password = askstring("Master Password", "Enter your master password:", show="*", parent=app)
    if master_password:
...
class PassVault(tk.Tk):
    ...
    def prompt_master_password(self):
        password = askstring("Master Password", "Set your master password:", show="*", parent=self)
        if password:
            confirm_password = askstring("Confirm Master Password", "Confirm your master password:", show="*", parent=self)
